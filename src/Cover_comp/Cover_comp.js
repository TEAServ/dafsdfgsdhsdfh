...
<img class="headerGif" src={gifSrc} style={{filter: `brightness(90%)`}} alt="this slowpoke moves"  />
          ...
          <div class="row BtnCoubleCont"> 
              <div class="col-md-6">
                  <button type="button" onClick={(e) => {this.ContactMeScroll(e)}} class="btn btn-outline-light BtnCouble ">Contact Me</button>

              </div>
              <div class="col-md-6">
                  <button type="button" class="btn btn-dark BtnCouble " >Send Message</button>
